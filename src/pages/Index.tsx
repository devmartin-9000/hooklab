  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Preview your ad hooks and creatives across multiple platforms and devices before spending a dollar. The ultimate tool for media buyers." />
      </Helmet>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">See your ad before the world does</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="bg-card border border-border rounded-xl p-6 shadow-md animate-fade-in">
                <h2 className="text-lg text-primary-foreground/90 font-semibold mb-4 flex items-center gap-2">
              ...
              <div className="bg-card border border-border rounded-xl p-6 shadow-md animate-fade-in" style={{ animationDelay: "0.1s" }}>
                <HookGenerator
                  hook={hook}
              ...
              <div className="bg-card border border-border rounded-xl p-6 shadow-md animate-fade-in" style={{ animationDelay: "0.2s" }}>
